    ...
    <div className="">
      ...
      <div className="row">
        ...
        <div className="col-md-4 mb-3">
          ...
          {/* <hr className='border border-info mt-0'/> */}
          <div className="border border-info border-2 p-3 rounded-2 bg-">
        ...
        <div className="col-md-4 mb-3">
          ...
          <div className="border border-2 p-3 rounded-2">
            <div className="form-check mb-3">
              <input className="form-check-input" type="checkbox" id="collisionDamageWaiver" />
              <label className="form-check-label" htmlFor="collisionDamageWaiver">
                Collision Damage Waiver $9.00
              </label>
            </div>
            <div className="form-check mb-3">
              <input className="form-check-input" type="checkbox" id="liabilityInsurance" />
              <label className="form-check-label" htmlFor="liabilityInsurance">
                Liability Insurance $15.00
              </label>
            </div>
            <div className="form-check mb-3">
              <input className="form-check-input" type="checkbox" id="rentalTax" />
